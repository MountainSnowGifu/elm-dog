	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Background$color(model.primaryDark)
					]))
			]),
		{
...
var $author$project$Main$paddingTop = function (sizze) {
	return $mdgriffith$elm_ui$Element$paddingEach(
		{bottom: 0, left: 0, right: 0, top: sizze});
};
...
var $author$project$Main$viewContent = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text($author$project$Main$text0)
				])),
			A2(
			$mdgriffith$elm_ui$Element$paragraph,
			_List_fromArray(
